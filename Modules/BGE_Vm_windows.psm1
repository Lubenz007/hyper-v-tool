function BGE_Vm_windows {
    ...
    function Show-OSMenu {
        ...
        Write-Host "1: Press '1' Windows 2022 Core"
        Write-Host "2: Press '2' Windows 2022 Standard"
        Write-Host "3: Press '3' Windows 2022 Datacenter."
    ...
    do {
        ...
        switch ($input) {
            '1' {
                $global:TemplateLocation = "$global:template\$global:2022core"
            } '2' {
                $global:TemplateLocation = "$global:template\$global:2022stand"
            } '3' {
                $global:TemplateLocation = "$global:template\$global:2022data"
            } 'q' {
                Return 
            }
        }
